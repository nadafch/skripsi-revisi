    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Input Graf</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <textarea id="result" rows="7" cols="80" class="form-control"></textarea>
                        </div> -->
                        <button id=graf>get</button>
                        <form action="../aksi/input_graf.php" method="POST">
                            <div class="form-group">
                            <textarea id="result" rows="7" cols="80" class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                            <label for="node_awal">Node Awal</label>
                            <select class="form-control" name="node_awal" id="node_awal">
                            ...
                            <div class="form-group">
                            <label for="node_tujuan">Node Tujuan</label>
...
function ajax_simpan() {
    ...
    var node_awal = document.getElementById('node_awal').value;
    var node_tujuan = document.getElementById('node_tujuan').value;
