    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Daftar Graf</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <!-- <div class="form-group">
                                <label>Graf</label>
                                <textarea class="form-control" id="graf"></textarea>
                            </div> -->
                        </div>
...
<?php 
$query1 = "SELECT graf FROM tb_graf WHERE NO ='$id'";
